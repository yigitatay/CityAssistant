...
class ChatApp:
    def __init__(self, root):
        ...
        self.root.configure(bg="#222")  # dark gray
    ...
    def send_message(self):
        if self.send_enabled:
            ...
            if user_message and len(user_message) > 0:
                ...
                self.display_message(f"User: {user_message}", color="black")
    ...
    def process_message(self, user_message):
        ...
        # City Assistant is prompted to add something like "not sure" to its response if not sure
        # TODO: This could be improved by adding a flag to the bot answer
    ...
    def display_message(self, message, color="black"):
        ...
        if message.startswith("City Assistant:"):
            ...
            report_button.config(borderwidth=1, relief="solid")
